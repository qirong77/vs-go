...
function createFloatingWindow(url = "https://www.baidu.com") {
    const oldWindow = floatingWindows.find((win) => !win.isDestroyed() && win.webContents.getURL() === url);
    if (oldWindow) {
        oldWindow.center();
        oldWindow.show();
        oldWindow.focus();
    ...
    const floatingWindow = new BrowserWindow({
        ...
        height: 600,
        alwaysOnTop: true,
        webPreferences: { sandbox: false, preload: path.join(__dirname, "../preload/index.js") },
    });
...
export const FloatingWindowManager = { createFloatingWindow, HideAllFloatingWindows, ShowAllFloatingWindows };
